...
gulp.task('copy:vendor', (done) => {
  ...
  gulp.src('node_modules/bootstrap-icons/icons/*')
    .pipe(gulp.dest(`${tmp.vendor}/bootstrap/icons`))
  ...
  gulp.src([
      'node_modules/jqvmap-novulnerability/dist/**/*.{css,js}'
    ])
  ...
  gulp.src([
      'node_modules/headroom.js/dist/*'
    ])
    .pipe(gulp.dest(`${tmp.vendor}/headroom.js`))

  gulp.src([
      'node_modules/zxcvbn/dist/*'
    ])
    .pipe(gulp.dest(`${tmp.vendor}/zxcvbn`))

  gulp.src([
      'node_modules/bootstrap-select/dist/**'
    ], {
      base: 'node_modules/bootstrap-select/dist'
    })
    .pipe(gulp.dest(`${tmp.vendor}/bootstrap-select`))

  gulp.src([
      'node_modules/aos/dist/*'
    ])
    .pipe(gulp.dest(`${tmp.vendor}/aos`))
